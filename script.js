$(document).ready(function () {
    $("#github").click(function () {
        window.open("https://github.com/deacondexter");
    });
});

$(document).ready(function () {
    $("#linkdin").click(function () {
        window.open("https://www.linkedin.com/in/paigeleary/");
    });
});
...
gitHubRequest.open("GET", "https://api.github.com/users/deacondexter/repos", true);
gitHubRequest.send();
